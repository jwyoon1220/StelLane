...
class SongSelectScene(
    ...
    companion object {
        private val COLOR_BG = RenderColor.of(10, 8, 20)
        private val COLOR_PANEL_GRAD_TOP = RenderColor.of(28, 18, 56, 215) // Soft translucent violet panel top
        private val COLOR_PANEL_GRAD_BTM = RenderColor.of(16, 10, 32, 215) // Soft translucent violet panel bottom
        private val COLOR_LINE_GRAD_LEFT = RenderColor.of(255, 107, 157, 180) // Glowing pink highlights (cute/sexy)
        private val COLOR_LINE_GRAD_RIGHT = RenderColor.of(163, 112, 247, 40)
        private val COLOR_HEADER_BG = RenderColor.of(22, 14, 42, 210)
        private val COLOR_HEADER_LINE = RenderColor.of(255, 107, 157, 120) // Glowing pink header divider
        private val COLOR_MODE_LABEL = RenderColor.of(255, 107, 157) // Neon pink mode text
        private val COLOR_SONGS_COUNT = RenderColor.of(140, 125, 175)
        private val COLOR_HINT = RenderColor.of(120, 110, 150)
        private val COLOR_EXPORT_MSG = RenderColor.of(255, 209, 102)
        private val COLOR_EXPORT_MSG_DONE = RenderColor.of(120, 220, 140)
        private val COLOR_COVER_GLOW_START = RenderColor.of(255, 107, 157, 0)
        private val COLOR_COVER_GLOW_END = RenderColor.of(0, 0, 0, 0)
        private val COLOR_COVER_PLACEHOLDER_TOP = RenderColor.of(50, 30, 85)
        private val COLOR_COVER_PLACEHOLDER_BTM = RenderColor.of(25, 15, 45)
        private val COLOR_COVER_NOTE_ICON = RenderColor.of(255, 107, 157, 120)
        private val COLOR_TITLE = RenderColor.of(255, 255, 255)
        private val COLOR_ARTIST = RenderColor.of(59, 206, 242) // Cyan artist text (pure/neat)
        private val COLOR_DIFF_BG = RenderColor.of(35, 20, 65, 180)
        private val COLOR_DIFF_BORDER = RenderColor.of(255, 107, 157, 120)
        private val COLOR_DIFF_ARROW = RenderColor.of(255, 209, 102)
        private val COLOR_SPEED = RenderColor.of(59, 206, 242)
        private val COLOR_SPEED_HINT = RenderColor.of(130, 120, 160)
        private val COLOR_ROW_SEL_GRAD_LEFT = RenderColor.of(255, 107, 157, 160) // Glowing pink selected list item
        private val COLOR_ROW_SEL_GRAD_RIGHT = RenderColor.of(163, 112, 247, 30)
        private val COLOR_ROW_SEL_INDICATOR = RenderColor.of(255, 107, 157)
        private val COLOR_ROW_HOVER = RenderColor.of(59, 206, 242, 25) // Cyan highlight hover
        private val COLOR_ROW_EVEN = RenderColor.of(255, 255, 255, 8)
        private val COLOR_ROW_LINE = RenderColor.of(50, 35, 85)
        private val COLOR_THUMB_SEL_BORDER = RenderColor.of(255, 107, 157, 180)
        private val COLOR_THUMB_BORDER = RenderColor.of(80, 60, 120, 120)
        private val COLOR_THUMB_PLACEHOLDER = RenderColor.of(35, 25, 60)
        private val COLOR_THUMB_PLACEHOLDER_BORDER = RenderColor.of(80, 60, 120)
        private val COLOR_ROW_SEL_TITLE = RenderColor.of(255, 255, 255)
        private val COLOR_ROW_TITLE = RenderColor.of(195, 185, 215)
        private val COLOR_ROW_SEL_ARTIST = RenderColor.of(59, 206, 242)
        private val COLOR_ROW_ARTIST = RenderColor.of(120, 105, 150)
        private val COLOR_BADGE_BG = RenderColor.of(255, 107, 157, 45)
        private val COLOR_BADGE_TEXT = RenderColor.of(255, 107, 157)
