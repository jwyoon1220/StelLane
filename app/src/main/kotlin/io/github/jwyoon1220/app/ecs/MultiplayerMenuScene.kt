...
class MultiplayerMenuScene(private val ctx: GameContext) : Scene() {
    ...
    override fun enter() { super.enter(); cursor = 0; time = 0.0 }
    ...
    override fun render(g: DrawContext) {
        ...
        items.forEachIndexed { i, label ->
            ...
            val iy = startY + i * rowH

            if (selected) {
                g.fillLinearGradient(
                    (px + 12).toFloat(), iy.toFloat(), (pw - 24).toFloat(), rowH.toFloat(),
            ...
            g.font = descFont
            g.renderColor = RenderColor.of(110, 100, 140)
